package com.mojiayi.action.dubbo.provider.order;
...
import com.mojiayi.action.dubbo.provider.order.service.OrderDetailService;
...
@SpringBootTest(classes = MojiayiOrderProvider.class)
